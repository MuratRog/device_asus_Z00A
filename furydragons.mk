...
$(call inherit-product, vendor/furydragons/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/furydragons/config/nfc_enhanced.mk)
